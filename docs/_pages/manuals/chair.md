...
1. 最后一次活动回顾
1. 新人流程
    1. 将新人邀请进入“AMC Open Forum - AMCOF” 微信群。（邀请人负责邀请。如果邀请人不在现场则由主席一人负责）
    1. 新人自我介绍（1 MIN）
1. 选出本次活动的学术主席
1. 展开本次活动内容
...
1. 会员升级
    1. 新人 -> 实习会员：第一次完成分享的新人，将升级为实习会员。由其邀请人负责将其加入“AI ML Club - AMC”会员群。（如果邀请人不在，则由当期主席负责）；
    1. 实习会员 -> 正式会员：参加了三次活动的实习会员（含三次），将有资格转为正式会员。转正要求：发送个人 Profile 页面的 Pull Request 至 <https://ai-ml.club/people/GITHUB_USERNAME/> 下。PR Merge 后正式成为 AMC 会员；
...
1. 轮值主席发言，做活动总结
1. 轮值主席总结本期 Pull Request 的 Approve & Merge 情况。（主席应该对自己任期内的 PR 负责，并在自己完成主席职责（发布活动纪要）之前，完成合并。对于无法合并的 PR ，应进行关闭）
...
1. Update information about yourself in `docs/_data/authors.yml`, set `membership` to `chair`

## 主席工具

1. [Online Time Timer](https://www.visnos.com/demos/classroom-timer)
